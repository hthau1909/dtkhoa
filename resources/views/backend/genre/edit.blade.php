...
@section('main')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="index.html">Thể loại</a></li>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="{{$genre->name_genre}}" name="name_genre" placeholder="Nhập tên thể loại" required>
                    </div>
                  </div>
                  <div class="form-group row mt-2">
                    <label class="col-sm-2 col-form-label">Mô tả (ngắn)</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" name="description">{{$genre->description}}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-10">
